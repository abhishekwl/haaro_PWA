  ...
  render() {
    ...
    const sideList = (
        <div className={classes.list}>
          <List>
            {['Medhuri', 'Shade', 'Dhanvi', 'Narasimha Prasanna H.N'].map((text, index) => (
          ...
          <Divider />
          <List>
            {['Kovvuri Tarun Naidu', 'Karthik G N', 'Kotapalli Venkata Rao'].map((text, index) => (
              <ListItem button key={text}>
                <ListItemIcon>{index % 2 === 0 ? <InboxIcon /> : <MailIcon />}</ListItemIcon>
                <ListItemText primary={text} />
              </ListItem>
      ...
      <div className={classes.root}>
        <AppBar>
          <Toolbar className={classes.toolbar}>
            <IconButton className={classes.menuButton} color="inherit" aria-label="Open drawer" onClick={this.toggleDrawer.bind(this)}>
              <MenuIcon />
            </IconButton>
